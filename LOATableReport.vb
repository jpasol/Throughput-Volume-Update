...
Public Class LOATableReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Throughput_Volume_Update.LOATableReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLOATableReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LOATableReport = New LOATableReport()
        rpt.Site = Me.Site
        Return rpt
    End Function

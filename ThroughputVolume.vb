...
Public Class ThroughputVolume
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Throughput_Volume_Update.ThroughputVolume.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedThroughputVolume
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ThroughputVolume = New ThroughputVolume()
        rpt.Site = Me.Site
        Return rpt
    End Function

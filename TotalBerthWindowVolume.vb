...
Public Class TotalBerthWindowVolume
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "TotalBerthWindowVolume.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Throughput_Volume_Update.TotalBerthWindowVolume.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTotalBerthWindowVolume
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TotalBerthWindowVolume = New TotalBerthWindowVolume()
        rpt.Site = Me.Site
        Return rpt
    End Function

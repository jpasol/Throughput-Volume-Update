...
Public Class BerthWindowVolume
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Throughput_Volume_Update.BerthWindowVolume.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBerthWindowVolume
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BerthWindowVolume = New BerthWindowVolume()
        rpt.Site = Me.Site
        Return rpt
    End Function

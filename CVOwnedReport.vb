...
Public Class CVOwnedReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Throughput_Volume_Update.CVOwnedReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCVOwnedReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CVOwnedReport = New CVOwnedReport()
        rpt.Site = Me.Site
        Return rpt
    End Function

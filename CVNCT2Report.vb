...
Public Class CVNCT2Report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Throughput_Volume_Update.CVNCT2Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCVNCT2Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CVNCT2Report = New CVNCT2Report()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class BerthHandlingServices
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "BerthHandlingServices.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Throughput_Volume_Update.BerthHandlingServices.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_berth() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedBerthHandlingServices
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BerthHandlingServices = New BerthHandlingServices()
        rpt.Site = Me.Site
        Return rpt
    End Function
